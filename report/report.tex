...
\section{ROSE: a tool for source-to-source compiling}
	...
	%define source-to-source compiling FIXME real definition.
	...
	%presentating ROSE + description (example)
	...
	%TODO TODO whole-project compatibility / object-oriented imperative approach / EDG frontend / limitations
...
#pragma omp parallel for
	...
	\end{lstlisting}
	%FIXME define translation somewhere
